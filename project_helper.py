...
def large_dollar_volume_tokens(df, price_column, volume_column, top_percent):
    """
    Get the tokens with the largest dollar volume tokens.
    ...
    Returns
    -------
    large_dollar_volume_tokens_symbols : List of str
        List of of large dollar volume token symbols
    """
...
def plot_benchmark_returns(benchmark_data, etf_data, title):
    ...
    layout = go.Layout(
        title=title,
        xaxis={'title': 'Date'},
        yaxis={'title': 'Cumulative Returns', 'range': [0, 6]})
